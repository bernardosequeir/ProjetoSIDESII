...
--
-- Host: 127.0.0.1
-- Tempo de geração: 03-Abr-2020 às 16:53
...
INSERT INTO `sistema` (`IDSistema`, `LimiteTemperatura`, `LimiteHumidade`, `LimiteLuminosidade`, `LimiarTemperatura`, `LimiarHumidade`, `LimiarLuminosidade`, `DuraçãoPadrãoRonda`, `PeriocidadeImportacaoExportacao`) VALUES
(1, '1.00', '1.00', '1.00', '1.00', '1.00', '1.00', 30, 1);
